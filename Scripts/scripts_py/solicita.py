...
columnas_a_excluir = ["Fecha", "id_marca", "query", "query dated", "Tipo", "Clase",  "Distingue", "tipo de signo", "Num Registro", "Fecha Registro", 
                        ...
                        "Comentarios", "Link comprobante recepcion", "vacio1", "vacio2", "vacio3", "id solicitante1", "id solicitante2",
...
with open("solicita2.sql", "w", encoding="utf-8") as f:
    f.write(sql_script)
