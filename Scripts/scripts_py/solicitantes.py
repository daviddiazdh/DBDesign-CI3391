...
# Incluye : "ID", "Tipo", "Documento", "Domicilio", "Pais de Domicilio", "Pais de Nacionalidad", "Correo Electronico", "Telefono", "Celular", "Fax", "Numero de agente"

columnas_a_excluir = ["Nombre/Razon Social", "Representante legal", "Cedula", "Numero de poder"]  # Lista de columnas a excluir
