...
# Devuelve: id_marca, Signo, tipo de signo, Descripcion etiqueta

columnas_a_excluir = ["query", "Tipo", "Clase", "Distingue", "query dated", "numero_solicitud", "Fecha", "Num Registro", "Fecha Registro", 
                        "Fecha Vencimiento", "Estado", "Tramitante/Agente", "Numero poder", "link_numero_solicitud", 
                        "Tabla", "Info Adicional", "Codigo", "Nombre titular", "Domicilio titular", "Nacionalidad titular", 
...
with open("insert_signo.sql", "w", encoding="utf-8") as f:
    f.write(sql_script)
